  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/blends" element={<ProtectedRoute><BlendsScreen /></ProtectedRoute>} />
        <Route path="/blend-details" element={<ProtectedRoute><BlendDetailScreen /></ProtectedRoute>} />
        <Route path="/calculators" element={<ProtectedRoute><CalculatorsScreen /></ProtectedRoute>} />
        <Route path="/data" element={<ProtectedRoute><DataScreen /></ProtectedRoute>} />
        <Route path="/details" element={<ProtectedRoute><DetailsScreen /></ProtectedRoute>} />
        <Route path="/documents" element={<ProtectedRoute><DocumentsScreen /></ProtectedRoute>} />
        <Route path="/harvest-loads" element={<ProtectedRoute><HarvestLoadsScreen /></ProtectedRoute>} />
        <Route path="/api" element={<ProtectedRoute><API_Screen /></ProtectedRoute>} />
        <Route path="/harvest" element={<ProtectedRoute><HarvestLoadsScreen /></ProtectedRoute>} />

        {/* Settings screens */}
        <Route path="/settings" element={<ProtectedRoute><SettingsScreen /></ProtectedRoute>} />
        <Route path="/settings/harvestload-form" element={<ProtectedRoute><HarvestLoadFormSettings /></ProtectedRoute>} />
